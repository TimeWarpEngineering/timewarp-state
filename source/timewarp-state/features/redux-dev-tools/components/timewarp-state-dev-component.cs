...
public class TimeWarpStateDevComponent : TimeWarpStateComponent
{
  ...
  protected TimeWarpStateDevComponent()
  {
    RenderModeDisplay = builder =>
    {
      ...
      builder.AddComponentParameter(0, nameof(Features.Developer.RenderModeDisplay.AssignedRenderModeName), AssignedRenderMode?.GetType().Name ?? "None");

#region Purpose
// Escape hatch so a state action handler may dispatch an action while TWS0003 keeps the debt visible.
#endregion
...
// Inherited walks the handler base chain; TWS0003 still fires on the attribute so the exemption
...
/// <summary>
/// Suppresses TWS0002 on a state action handler type or method so a dispatch may remain while it is
/// converted to a notification. TWS0003 reports the exemption as an info diagnostic.
/// </summary>

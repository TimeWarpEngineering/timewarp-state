...
{
    public async Task ThrowServerSideException(string message, CancellationToken? externalCancellationToken = null)
    {
        ...
        await Sender.Send
        (
            new ThrowServerSideExceptionActionSet.Action(message),

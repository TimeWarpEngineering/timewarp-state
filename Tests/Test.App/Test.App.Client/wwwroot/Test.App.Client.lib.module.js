...
const dispatchIncrementCountAction = () => {
  ...
  const IncrementCountActionName = "Test.App.Client.Features.Counter.CounterZeroState+IncrementCounterAction, Test.App.Client, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";

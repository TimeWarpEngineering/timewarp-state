...
- [x] CI `ci` on PR #578 green after JS-interop wait (merged onto feature, then master via #579)
...
- 2026-09-05: cockpit board hygiene — product already on master (#578 → #579); origin-home kitchen was still `in-progress`. `ganda kanban done 080-003`. No product change.
